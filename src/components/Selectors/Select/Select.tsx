    ...
    return (
        <div className="relative">
            <button
                ...
                className="select flex w-fit items-center justify-between rounded-[var(--radius-md)] bg-[var(--color-background)] p-[12px_7px_8px_7px]"
            >
                ...
                <span className="flex items-center">
                    <svg
                        ...
                        viewBox="0 0 9 5"
                        fill="none"
                        className={`h-[7px] w-[11px] transition-transform duration-200 ${
                            isOpen ? "rotate-180" : ""
                        }`}
                    >
                        <path
